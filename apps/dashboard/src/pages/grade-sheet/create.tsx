...
import { ICreateGradeSheet } from "../../common/types/models";
import { GradeSheetForm } from "./form/form";

export const GradeSheetCreate = () => {
	...
	const { formProps, saveButtonProps } = useForm<ICreateGradeSheet>({
		...
		onMutationError: (error) => {
			console.error("GradeSheet Create Error:", error);
		},
	...
	return (
		...
		>
			<GradeSheetForm formProps={{ ...formProps }} />
		</Create>
	);
};
