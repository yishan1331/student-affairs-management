...
import { ICreateSchool } from "../../common/types/models";
...
export const SchoolCreate = () => {
	...
	const { formProps, saveButtonProps } = useForm<ICreateSchool>({
		resource: ROUTE_RESOURCE.school,
		id,
		action: "create",
		redirect: false,
		onMutationSuccess: () => {
			console.log("=== School Create - onMutationSuccess ===");
		...
		onMutationError: (error) => {
			console.error("=== School Create - onMutationError ===");
