...
export const SalaryBaseEdit = () => {
	...
	const { formProps, saveButtonProps } = useForm<IUpdateSalaryBase>({
		...
		meta: {
			auditLog: {
				permissions: ["salary-base:update"],
			},
		},
	});
