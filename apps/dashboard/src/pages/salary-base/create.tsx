...
import { ICreateSalaryBase } from "../../common/types/models";
import { SalaryBaseForm } from "./form/form";

export const SalaryBaseCreate = () => {
	...
	const { formProps, saveButtonProps } = useForm<ICreateSalaryBase>({
		...
		onMutationError: (error) => {
			console.error("=== SalaryBase Create - onMutationError ===");
		...
		meta: {
			auditLog: {
				permissions: ["salary-base:create"],
			},
		},
	});
	...
	return (
		...
		>
			<SalaryBaseForm formProps={{ ...formProps }} />
		</Create>
	);
};
