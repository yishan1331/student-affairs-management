...
import { ICreateHealthToilet } from "../../common/types/models";
import { HealthToiletForm } from "./form/form";

export const HealthToiletCreate = () => {
	...
	const { formProps, saveButtonProps } = useForm<ICreateHealthToilet>({
		...
		onMutationError: (error) => {
			console.error("HealthToilet Create Error:", error);
		},
