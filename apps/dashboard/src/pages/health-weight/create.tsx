...
import { ICreateHealthWeight } from "../../common/types/models";
import { HealthWeightForm } from "./form/form";

export const HealthWeightCreate = () => {
	...
	const { formProps, saveButtonProps } = useForm<ICreateHealthWeight>({
		...
		onMutationError: (error) => {
			console.error("HealthWeight Create Error:", error);
		},
	...
	return (
		...
		>
			<HealthWeightForm formProps={{ ...formProps }} />
		</Create>
	);
};
