...
import { ICreateHealthDiet } from "../../common/types/models";
import { HealthDietForm } from "./form/form";

export const HealthDietCreate = () => {
	...
	const { formProps, saveButtonProps } = useForm<ICreateHealthDiet>({
		...
		onMutationError: (error) => {
			console.error("HealthDiet Create Error:", error);
		},
	...
	return (
		...
		>
			<HealthDietForm formProps={{ ...formProps }} />
		</Create>
	);
};
